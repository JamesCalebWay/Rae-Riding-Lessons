...
<html>
    ...
    <body>
        ...
        <a href='index.php' style="float: left">R<img src=images\RaeRidingTitleLogo.png></img></a> <!--probably need to resize-->        <a href='http://raeridinglessons.infinityfreeapp.com/functions/logout.php'>Logout</a>
