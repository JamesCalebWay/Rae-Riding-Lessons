...
<html>
    ...
    <body>
        ...
        <div class='topnav' id='myTopnav'>
            <a href='index.php' style="float: left"><img src="http://raeridinglessons.infinityfreeapp.com/images/RaeLogo.png" alt="Rae Riding Lessons" style="width:81px; height:50px;"></img></a> <!-- resized-->            <a href='http://raeridinglessons.infinityfreeapp.com/functions/logout.php'>Logout</a>
            <?php loginButton() ?>
